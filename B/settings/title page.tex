...
\makebox[8\ccwd][s]{研究生姓名：} & \NameInnerValue \\[0.75\ccwd]
\makebox[8\ccwd][s]{指导教师：} & \MentorInnerValue \\[0.75\ccwd]
\makebox[8\ccwd][s]{学科专业：} & \MajorInnerValue \\[0.75\ccwd]
\makebox[8\ccwd][s]{研究方向：} & \DirectionInnerValue \\[0.75\ccwd]
